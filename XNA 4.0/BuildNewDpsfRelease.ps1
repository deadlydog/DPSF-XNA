...
# If the 'C:\DPSF' directory does not exist, create it before we copy files to it.
if (!(Test-Path -Path $DPSF_DEFAULT_INSTALL_DIRECTORY))
{
    New-Item -ItemType Directory -Path $DPSF_DEFAULT_INSTALL_DIRECTORY > $null
}
