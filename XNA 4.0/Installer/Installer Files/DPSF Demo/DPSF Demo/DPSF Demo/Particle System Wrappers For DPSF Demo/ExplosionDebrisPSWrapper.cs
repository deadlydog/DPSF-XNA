...
namespace DPSF_Demo.Particle_System_Wrappers_For_DPSF_Demo
{
	...
	[Serializable]
#endif
	class ExplosionDebrisDPSFDemoParticleSystemWrapper : ExplosionDebrisParticleSystem, IWrapDPSFDemoParticleSystems
	{
        public ExplosionDebrisDPSFDemoParticleSystemWrapper(Game cGame)
            : base(cGame)
        { }
