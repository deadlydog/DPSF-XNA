...
{
	/// <summary>
	/// Base class that provides a basic virtual environment with common requirements (floor, camera, process input, draw text, etc.).
    /// This class can stand-alone, or can be inherited and built upon by other classes.
	/// </summary>
	public class BasicVirtualEnvironmentBase : Microsoft.Xna.Framework.Game
	{
		#region Fields
		...
		/// Constructor
		/// </summary>
		public BasicVirtualEnvironmentBase()
		{
		...
		protected override void LoadContent()
		{
			...
			_floorModel = Content.Load<Model>("Models/grid");
