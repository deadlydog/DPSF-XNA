...
{
	class GridQuadDPSFDemoParticleSystemWrapper : GridQuadParticleSystem, IWrapDPSFDemoParticleSystems
	{
        public GridQuadDPSFDemoParticleSystemWrapper(Game cGame)
            : base(cGame)
        { }
