...
{
	class ExplosionDPSFDemoParticleSystemWrapper : ExplosionParticleSystem, IWrapDPSFDemoParticleSystems
	{
        public ExplosionDPSFDemoParticleSystemWrapper(Game cGame)
            : base(cGame)
        { }
