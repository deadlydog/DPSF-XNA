...
namespace DPSF_Demo.Particle_System_Wrappers_For_DPSF_Demo
{
	...
	[Serializable]
#endif
	class ExplosionDebrisSpriteDPSFDemoParticleSystemWrapper : ExplosionDebrisSpriteParticleSystem, IWrapDPSFDemoParticleSystems
	{
        public ExplosionDebrisSpriteDPSFDemoParticleSystemWrapper(Game cGame)
            : base(cGame)
        { }
