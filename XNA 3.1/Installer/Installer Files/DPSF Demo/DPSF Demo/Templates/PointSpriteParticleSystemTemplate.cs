...
namespace DPSF.ParticleSystems
{
    ...
    class PointSpriteParticleSystemTemplate : DPSF<PointSpriteParticleSystemTemplateParticle, PointSpriteParticleSystemTemplateParticleVertex>
    {
        ...
        protected virtual void UpdateVertexProperties(ref PointSpriteParticleSystemTemplateParticleVertex[] sVertexBuffer, int iIndex, DPSFParticle Particle)
        {
        ...
        protected void UpdateParticlePositionUsingVelocity(PointSpriteParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
        {
