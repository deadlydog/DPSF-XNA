...
namespace DPSF.ParticleSystems
{
    ...
    class SparklerParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        protected void UpdateParticleVelocityRandomly(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Velocity = DPSFHelper.RandomNormalizedVector() * mfParticleSpeed;
        }

        protected void UpdateParticleToChange(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Velocity = DPSFHelper.RandomNormalizedVector() * mfParticleSpeed;
