...
//            mcGraphicsDevice.RenderState.FillMode = FillMode.WireFrame;
            mcGraphicsDevice.RenderState.CullMode = CullMode.None;
            mcGraphicsDevice.RenderState.DepthBufferEnable = true;
            ...
            foreach (EffectPass pass in mcEffect.CurrentTechnique.Passes)
            {
                ...
                mcGraphicsDevice.SamplerStates[0].AddressU = TextureAddressMode.Mirror;
                mcGraphicsDevice.SamplerStates[0].AddressV = TextureAddressMode.Mirror;

                // Draw the Terrain
                mcGraphicsDevice.VertexDeclaration = mcVertexDeclaration;
                mcGraphicsDevice.Indices = mcIndexBuffer;
                mcGraphicsDevice.Vertices[0].SetSource(mcVertexBuffer, 0, VertexPositionNormalTexture.SizeInBytes);
...
*/
            ...
            mcVertexDeclaration = new VertexDeclaration(mcGraphicsDevice, VertexPositionNormalTexture.VertexElements);
        }
        ...
        private void CopyToBuffers()
        {
            ...
            mcVertexBuffer = new VertexBuffer(mcGraphicsDevice, msaTerrainVertices.Length * VertexPositionNormalTexture.SizeInBytes, BufferUsage.WriteOnly);
