...
namespace DPSF
{
    ...
    public class DPSFHelper
    {
        ...
        /// </summary>
        /// <param name="fNormalizedLifetime">The current Normalized Elapsed Time (0.0 - 1.0) of a Particle</param>
        /// <returns>Returns the Alpha Color component that should be used for the Particle</returns>
        public static byte FadeInQuicklyAndFadeOutSlowlyBasedOnLifetime(float fNormalizedLifetime)
        {
            // Calculate how transparent the Particle should be based on it's NormalizedLifetime
            return (byte)((fNormalizedLifetime * (1 - fNormalizedLifetime) * (1 - fNormalizedLifetime) * 6.7) * 255);
        }
        ...
        /// a point somewhere in the cube-shaped AREA between the two points.
        /// </summary>
