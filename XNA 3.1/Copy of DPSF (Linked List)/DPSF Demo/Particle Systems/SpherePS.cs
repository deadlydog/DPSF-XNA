...
{
    class SphereParticle : DefaultPointSpriteParticle
    {
    ...
    /// </summary>
    class SphereParticleSystem : DPSFDefaultPointSpriteParticleSystem<SphereParticle, DefaultPointSpriteParticleVertex>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected override void SetRenderState(RenderState cRenderState)
        {
            ...
            cRenderState.DestinationBlend = Blend.One;      // Turn on additive blending
        }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager)
        {
            ...
            InitializePointSpriteParticleSystem(cGraphicsDevice, cContentManager, miNumberOfParticles, miNumberOfParticles, 
        ...
        public void UpdateParticlePositionToRotateAroundEmitter(SphereParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public void UpdateParticleDistanceFromEmitter(SphereParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public void UpdateParticlePivotRotationVelocityRandomly(SphereParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.sPivotRotationVelocity = DPSFHelper.RandomNormalizedVector() * mfParticlePivotRotationMaxSpeed * RandomNumber.NextFloat();
        }

        public void UpdateParticlePivotRotationVelocityToBeTheSame(SphereParticle cParticle, float fElapsedTimeInSeconds)
        {
