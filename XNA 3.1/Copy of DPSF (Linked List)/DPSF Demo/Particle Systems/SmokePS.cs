...
namespace DPSF.ParticleSystems
{
    ...
    class SmokeParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        //===========================================================
        public void IncreaseSizeBasedOnLifetime(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Size = ((1.0f + cParticle.NormalizedElapsedTime) / 1.0f) * cParticle.StartSize;
        }

        public void UpdateColor(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Color = msaColors[miCurrentColor];
        }

        public void RepelParticleFromExternalObject(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public void AttractParticleToExternalObject(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
