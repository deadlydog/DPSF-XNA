...
namespace DPSF.ParticleSystems
{
    ...
    class QuadParticleSystemTemplate : DPSF<QuadParticleSystemTemplateParticle, QuadParticleSystemTemplateParticleVertex>
    {
        ...
        public virtual void UpdateVertexProperties(ref QuadParticleSystemTemplateParticleVertex[] sVertexBuffer, int iIndex, DPSFParticle Particle)
        {
        ...
        public void UpdateParticlePositionUsingVelocity(QuadParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        /// <param name="cParticle">The Particle to update</param>
        /// <param name="fElapsedTimeInSeconds">How long it has been since the last update</param>
        public void UpdateParticleToFaceTheCamera(QuadParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
        {
