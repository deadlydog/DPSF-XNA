...
namespace DPSF
{
	...
	public class ParticleSystemManager
	{
		...
		public bool RemoveParticleSystem(IDPSFParticleSystem cParticleSystemToRemove)
		{
			...
			cParticleSystemToRemove.UpdateOrderChanged -= new EventHandler(RecordThatAnUpdateOrderHasBeenChanged);
			cParticleSystemToRemove.DrawOrderChanged -= new EventHandler(RecordThatADrawOrderHasBeenChanged);
