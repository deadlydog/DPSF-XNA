    ...
    static class Program
    {
        static void Main()
        {
            using (GameMain Game = new GameMain())
            {
                ...
                using (Microsoft.Win32.RegistryKey xnaKey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey("Software\\Microsoft\\XNA\\Framework\\v3.1"))
                {
                ...
                using (Microsoft.Win32.RegistryKey netKey35 = Microsoft.Win32.Registry.LocalMachine.OpenSubKey("SOFTWARE\\Microsoft\\NET Framework Setup\\NDP\\v3.5"))
                {
