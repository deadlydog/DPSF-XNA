...
namespace DPSF.ParticleSystems
{
    ...
    class SnowParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        //===========================================================
        protected void UpdateParticleDieOnceGroundIsHit(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        protected void UpdateParticleChangeVelocityAndRotation(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        protected void UpdateParticleAddWindForce(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.ExternalForce = Vector3.Lerp(Vector3.Zero, mcMaxWindForce, RandomNumber.Between(0.1f, 1.0f));
        }

        protected void UpdateParticleRemoveWindForce(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
