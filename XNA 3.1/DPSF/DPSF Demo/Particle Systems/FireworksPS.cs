...
namespace DPSF.ParticleSystems
{
    ...
    class FireworksParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        protected override void AfterInitialize()
        {
            ...
            mcFireworksExplosionParticleSystem1.AutoInitialize(GraphicsDevice, ContentManager, null);
            mcFireworksExplosionParticleSystem1.SetTexture("Textures/Star");

			mcFireworksExplosionParticleSystem2.AutoInitialize(GraphicsDevice, ContentManager, null);
            mcFireworksExplosionParticleSystem2.SetTexture("Textures/Cloud");

			mcFireworksExplosionParticleSystem3.AutoInitialize(GraphicsDevice, ContentManager, null);
            mcFireworksExplosionParticleSystem3.SetTexture("Textures/Spark");

			mcFireworksExplosionParticleSystem4.AutoInitialize(GraphicsDevice, ContentManager, null);
			...
			mcFireworksExplosionSmokeParticleSystem.AutoInitialize(GraphicsDevice, ContentManager, null);
        ...
        //===========================================================
        protected void CreateExplosionParticles(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public class FireworksExplosionParticleParticleSystem : DefaultPointSpriteParticleSystem
        {
            ...
            protected void RandomlyToggleVisiblity(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
            {
