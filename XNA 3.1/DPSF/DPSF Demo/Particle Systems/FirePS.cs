...
namespace DPSF.ParticleSystems
{
    ...
    class FireParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        //===========================================================
        protected void ReduceSizeBasedOnLifetime(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Size = ((1.0f - cParticle.NormalizedElapsedTime) / 1.0f) * cParticle.StartSize;
        }

        protected void GenerateSmokeParticle(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            // If the Smoke Particle System is initialized
