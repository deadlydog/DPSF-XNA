...
namespace DPSF.ParticleSystems
{
    ...
    /// </summary>
    [Serializable]
    class SmokeParticleSystem : DefaultPointSpriteParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public void InitializeParticleRisingSmoke(DefaultPointSpriteParticle cParticle)
        {
        ...
        public void InitializeParticleFoggySmoke(DefaultPointSpriteParticle cParticle)
        {        
        ...
        //===========================================================
        protected void IncreaseSizeBasedOnLifetime(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Size = ((1.0f + cParticle.NormalizedElapsedTime) / 1.0f) * cParticle.StartSize;
        }

        protected void UpdateColor(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            cParticle.Color = msaColors[miCurrentColor];
        }

        protected void RepelParticleFromExternalObject(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        protected void AttractParticleToExternalObject(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
