...
namespace DPSF.ParticleSystems
{
    ...
    class FountainParticleSystem : DefaultPointSpriteParticleSystem
    {
        ...
        //===========================================================
        protected void UpdateParticleBounceOffFloor(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        {
            this.ParticleEvents.RemoveEveryTimeEvents(UpdateParticleSizeUsingLerp);
            this.ParticleEvents.AddEveryTimeEvent(UpdateParticleSizeUsingLerp);
        }
