...
namespace DPSF.ParticleSystems
{
    ...
    class PixelParticleSystemTemplate : DPSF<PixelParticleSystemTemplateParticle, PixelParticleSystemTemplateParticleVertex>
    {
        ...
        protected virtual void UpdateVertexProperties(ref PixelParticleSystemTemplateParticleVertex[] sVertexBuffer, int iIndex, DPSFParticle Particle)
        {
        ...
        protected void UpdateParticlePositionUsingVelocity(PixelParticleSystemTemplateParticle cParticle, float fElapsedTimeInSeconds)
        {
