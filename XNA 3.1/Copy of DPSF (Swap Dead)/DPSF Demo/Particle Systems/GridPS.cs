...
namespace DPSF.ParticleSystems
{
    ...
    /// </summary>
    class GridParticleSystem : DefaultPointSpriteParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public GridParticleSystem(Game cGame) : base(cGame) { }
        ...
        public void InitializeParticleProperties(DefaultPointSpriteParticle cParticle)
        {
            ...
            int iParticleNumber = (NumberOfActiveParticles - 1);
            ...
            cParticle.Size = cParticle.StartSize = miStartSize;
            cParticle.EndSize = miEndSize;
        ...
        public void UpdateParticleResetProperties(DefaultPointSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            ...
            cParticle.StartSize = miStartSize;
            cParticle.EndSize = miEndSize;
        }
