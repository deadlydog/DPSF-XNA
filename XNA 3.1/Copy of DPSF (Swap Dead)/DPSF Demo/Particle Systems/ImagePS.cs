...
namespace DPSF.ParticleSystems
{
    ...
    class ImageParticleSystem : DPSFDefaultAnimatedTexturedQuadParticleSystem<ImageParticle, DefaultTexturedQuadParticleVertex>
    {
        ...
        //===========================================================
        public void RotateAroundOrigin(ImageParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public void MoveToFinalPosition(ImageParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        private void SetParticlePositionWidthHeightAndTextureCoordinatesToFormImage(ImageParticle cParticle)
        {
            ...
            int iRow = (NumberOfActiveParticles - 1) / miNumberOfColumns;
            int iColumn = (NumberOfActiveParticles - 1) % miNumberOfColumns;
        ...
        public void ToggleSpin(string sSpinMode)
        {
            ...
            for (int iIndex = 0; iIndex < NumberOfActiveParticles; iIndex++)
            {
                ...
                ImageParticle cParticle = Particles[iIndex];
        ...
        public void Scatter()
        {
            ...
            for (int iIndex = 0; iIndex < NumberOfActiveParticles; iIndex++)
            {
                ...
                int iSize = NumberOfActiveParticles;
                if (RandomNumber.Next(0, iSize) < (iSize / 10))
                {
                    // Swap the Position of this Particle with another
                    int iParticleToSwapWith = RandomNumber.Next(0, NumberOfActiveParticles);

                    ImageParticle cSwapParticle = Particles[iParticleToSwapWith];
