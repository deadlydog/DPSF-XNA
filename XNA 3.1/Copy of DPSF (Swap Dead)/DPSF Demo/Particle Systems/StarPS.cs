...
namespace DPSF.ParticleSystems
{
    ...
    /// </summary>
    class StarParticleSystem : DefaultPointSpriteParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public void InitializeParticleStar2D(DefaultPointSpriteParticle cParticle)
        {
            InitializeParticleUsingInitialProperties(cParticle);

            // Add 7 more Particles, going in different 2D directions
            DefaultPointSpriteParticle cParticle2 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle3 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle4 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle5 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle6 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle7 = new DefaultPointSpriteParticle();
            DefaultPointSpriteParticle cParticle8 = new DefaultPointSpriteParticle();
        ...
        public void InitializeParticleStar3D(DefaultPointSpriteParticle cParticle)
        {
        ...
        //===========================================================
        public void ReverseEmitterVelocities(float fElapsedTimeInSeconds)
        {
        ...
        public void LoadSlowWiggle()
        {
            ...
            ParticleSystemEvents.AddTimedEvent(0.1f, ReverseEmitterVelocities);
