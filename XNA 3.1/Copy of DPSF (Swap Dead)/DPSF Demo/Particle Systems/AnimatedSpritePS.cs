...
namespace DPSF.ParticleSystems
{
    ...
    class AnimatedSpriteParticleSystem : DefaultAnimatedSpriteParticleSystem
    {
        ...
        DefaultAnimatedSpriteParticle mcMouseParticle = null;
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager)
        {
            ...
            SpriteBatchSettings.BlendMode = SpriteBlendMode.AlphaBlend;
        ...
        public void LoadButterflyEvents()
        {
            ...
            InitialProperties.StartHeightMin = 100.0f;
            InitialProperties.StartHeightMax = 100.0f;
            InitialProperties.EndWidthMin = 100.0f;
            InitialProperties.EndWidthMax = 100.0f;
            InitialProperties.EndHeightMin = InitialProperties.EndWidthMin;
            InitialProperties.EndHeightMax = InitialProperties.EndWidthMax;
        ...
        public void InitializeParticleAnimatedButterfly(DefaultAnimatedSpriteParticle cParticle)
        {
            ...
            if (NumberOfActiveParticles == 1)
            {
                ...
                // Save a handle to this Butterfly
                mcMouseParticle = cParticle;
            }
            else
            {
                // Set this new Particle to start from the same position in the Animation as the Mouse Butterfly currently is
                cParticle.Animation.CurrentAnimationsPictureRotationOrderIndex = Particles[0].Animation.CurrentAnimationsPictureRotationOrderIndex;
        ...
        public void BounceOffScreenEdges(DefaultAnimatedSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
        ...
        public void ChangeDirectionRandomly(DefaultAnimatedSpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            // If this is the Mouse butterfly
            if (cParticle == mcMouseParticle)
            {
        ...
        public Vector3 MousePosition
        {
            ...
            set
            {
                ...
                if (mcMouseParticle != null)
                {
                    mcMouseParticle.Position = value;
                }
            }
        }
