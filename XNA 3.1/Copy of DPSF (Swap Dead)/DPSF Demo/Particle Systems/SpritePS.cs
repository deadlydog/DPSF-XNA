...
namespace DPSF.ParticleSystems
{
    ...
    class SpriteParticleSystem : DPSFDefaultSpriteParticleSystem<SpriteParticle, DefaultSpriteParticleVertex>
    {
        ...
        public void LoadAttractionEvents()
        {
            ...
            ParticleEvents.AddEveryTimeEvent(UpdateParticlePositionAndVelocityUsingAcceleration, 500);
            ParticleEvents.AddEveryTimeEvent(KeepParticleOnScreen, 1000);
        ...
        public void InitializeParticleAttraction(DPSFParticle Particle)
        {
            ...
            cParticle.Width = cParticle.Height = 20;
            ...
            if (NumberOfActiveParticles == 1)
            {
                ...
                cParticle.Width = cParticle.Height = 60;
        ...
        public void LoadRotatorsEvents()
        {
            ...
            ParticleEvents.RemoveAllEvents();
            ParticleEvents.AddEveryTimeEvent(RotateParticleAroundPivotPoint);
        }
        ...
        public void KeepParticleOnScreen(SpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            // If this is the Attractor
            if (cParticle == Particles[0])
            {
                // Place the Attractor at the Mouse Position and exit
                Particles[0].Position = msAttractorPosition;
                return;
            }
        ...
        public void AttractParticleToAttractor(SpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            // If this is the Attractor
            if (cParticle == Particles[0])
            {
        ...
        public void RepelParticleFromAttractor(SpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            // If this is the Attractor
            if (cParticle == Particles[0])
            {
        ...
        public void RotateParticleAroundPivotPoint(SpriteParticle cParticle, float fElapsedTimeInSeconds)
        {
            ...
            set
            {
                ...
                if (Name.Equals("Sprite Cloud"))
                {
                    switch (meAttractorMode)
                    {
                        ...
                        case EAttractorModes.Attract:
                            ParticleEvents.AddEveryTimeEvent(AttractParticleToAttractor, 400, 1);
                        break;

                        case EAttractorModes.Repel:
                            ParticleEvents.AddEveryTimeEvent(RepelParticleFromAttractor, 400, 1);
                        break;
                ...
                else
                {
                    switch (meAttractorMode)
                    {
                        ...
                        case EAttractorModes.None:
                            // Apply Gravity
                            for (int iIndex = 0; iIndex < NumberOfActiveParticles; iIndex++)
                            {
                                Particles[iIndex].ExternalForce = Vector3.Zero;
                                Particles[iIndex].Friction = 0;
                                Particles[iIndex].Acceleration = Vector3.Zero;
                            }
                        break;
                        ...
                        case EAttractorModes.Attract:
                            ...
                            for (int iIndex = 0; iIndex < NumberOfActiveParticles; iIndex++)
                            {
                                Particles[iIndex].ExternalForce = new Vector3(0, mfGravity, 0);
                                Particles[iIndex].Friction = 0;
                            }
                        break;
                        ...
                        case EAttractorModes.AttractFriction:
                            ...
                            for (int iIndex = 0; iIndex < NumberOfActiveParticles; iIndex++)
                            {
                                Particles[iIndex].Friction = mfGravity;
                                Particles[iIndex].ExternalForce = Vector3.Zero;
                            }
                        break;
