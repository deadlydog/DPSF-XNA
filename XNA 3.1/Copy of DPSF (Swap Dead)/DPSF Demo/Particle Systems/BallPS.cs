...
namespace DPSF.ParticleSystems
{
    ...
    class BallParticle : DefaultPointSpriteParticle
    {
    ...
    /// </summary>
    class BallParticleSystem : DPSFDefaultPointSpriteParticleSystem<BallParticle, DefaultPointSpriteParticleVertex>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public void InitializeParticleBall(BallParticle cParticle)
        {
            ...
            if ((NumberOfActiveParticles - 1) < iOneThirdOfParticlesAllowed)
            {
            ...
            else if ((NumberOfActiveParticles - 1) < (2 * iOneThirdOfParticlesAllowed))
            {
                // Find Particle's position on the Vertical Circle
                float fAngle = fStepSize * NumberOfActiveParticles;                
        ...
        //===========================================================
        public void UpdateParticlePositionAccordingToEmitter(BallParticle cParticle, float fElapsedTimeInSeconds)
        {
