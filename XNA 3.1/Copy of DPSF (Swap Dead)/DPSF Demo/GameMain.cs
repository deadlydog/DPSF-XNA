...
namespace Demo
{
    ...
    public class GameMain : Microsoft.Xna.Framework.Game
    {
        ...
        float mfStaticParticleTotalTime = 3.0f; // The Total amount of Time that the Static Particle should be drawn over
        ...
        enum EPSEffects
        {
            ...
            LastInList = 34     // This value should be the same as the Effect with the largest value
        }
        ...
        enum ETextures
        {
            ...
            WordBubble = 52,
            X = 53,
            LastInList = 53     // This value should be the same as the Texture with the largest value
        }
        ...
        FireballParticleSystem mcDefaultPixelParticleSystemTemplate = null;
        ...
        protected override void LoadContent()
        {
            ...
            mcDefaultPixelParticleSystemTemplate = new FireballParticleSystem(this);
            ...
            mcPixelParticleSystem.DrawOrder = 2000;
        ...
        public void InitializeCurrentParticleSystem()
        {
            ...
            switch (meCurrentPS)
            {
                ...
                case EPSEffects.Random:
                    ...
                    mcRandomParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcRandomParticleSystem;
                break;

                case EPSEffects.Fire:
                    // Initialize the Fire Particle System
                    mcFireParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcFireParticleSystem;
                break;

                case EPSEffects.Smoke:
                    // Initialize the Smoke Particle System
                    mcSmokeParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSmokeParticleSystem;
                break;

                case EPSEffects.Snow:
                    // Initialize the Snow Particle System
                mcSnowParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSnowParticleSystem;
                break;

                case EPSEffects.SquarePattern:
                    // Initialize the Square Pattern Particle System
                    mcSquarePatternParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSquarePatternParticleSystem;
                break;

                case EPSEffects.Fountain:
                    // Initialize the Fountain Particle System
                    mcFountainParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcFountainParticleSystem;
                break;

                case EPSEffects.Random2D:
                    mcRandom2DParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcRandom2DParticleSystem;
                break;

                case EPSEffects.GasFall:
                    mcGasFallParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcGasFallParticleSystem;
                break;

                case EPSEffects.Dot:
                    mcDotParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDotParticleSystem;
                break;

                case EPSEffects.Fireworks:
                    mcFireworksParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcFireworksParticleSystem;
                break;

                case EPSEffects.Figure8:
                    mcFigure8ParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcFigure8ParticleSystem;
                break;

                case EPSEffects.Star:
                    mcStarParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcStarParticleSystem;
                break;

                case EPSEffects.Ball:
                    mcBallParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcBallParticleSystem;
                break;

                case EPSEffects.RotatingQuad:
                    mcRotatingQuadParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcRotatingQuadParticleSystem;
                break;

                case EPSEffects.Box:
                    mcBoxParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcBoxParticleSystem;
                break;

                case EPSEffects.Image:
                    mcImageParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcImageParticleSystem;
                break;

                case EPSEffects.AnimatedTexturedQuad:
                    mcAnimatedQuadParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcAnimatedQuadParticleSystem;
                break;

                case EPSEffects.Sprite:
                    mcSpriteParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSpriteParticleSystem;
                break;

                case EPSEffects.AnimatedSprite:
                    mcAnimatedSpriteParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcAnimatedSpriteParticleSystem;
                break;

                case EPSEffects.Pixel:
                    mcPixelParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcPixelParticleSystem;
                break;

                case EPSEffects.Magnets:
                    mcMagnetParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcMagnetParticleSystem;
                break;

                case EPSEffects.Sparkler:
                    mcSparklerParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSparklerParticleSystem;
                break;

                case EPSEffects.Grid:
                    mcGridParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcGridParticleSystem;
                break;

                case EPSEffects.GridQuad:
                    mcGridQuadParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcGridQuadParticleSystem;
                break;

                case EPSEffects.Sphere:
                    mcSphereParticleSystem.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSphereParticleSystem;
                break;

                case EPSEffects.PixelParticleSystemTemplate:
                    mcPixelParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcPixelParticleSystemTemplate;
                break;

                case EPSEffects.SpriteParticleSystemTemplate:
                    mcSpriteParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcSpriteParticleSystemTemplate;
                break;

                case EPSEffects.PointSpriteParticleSystemTemplate:
                    mcPointSpriteParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcPointSpriteParticleSystemTemplate;
                break;

                case EPSEffects.QuadParticleSystemTemplate:
                    mcQuadParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcQuadParticleSystemTemplate;
                break;

                case EPSEffects.TexturedQuadParticleSystemTemplate:
                    mcTexturedQuadParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcTexturedQuadParticleSystemTemplate;
                break;

                case EPSEffects.DefaultPixelParticleSystemTemplate:
                    mcDefaultPixelParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDefaultPixelParticleSystemTemplate;
                break;

                case EPSEffects.DefaultSpriteParticleSystemTemplate:
                    mcDefaultSpriteParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDefaultSpriteParticleSystemTemplate;
                break;

                case EPSEffects.DefaultPointSpriteParticleSystemTemplate:
                    mcDefaultPointSpriteParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDefaultPointSpriteParticleSystemTemplate;
                break;

                case EPSEffects.DefaultQuadParticleSystemTemplate:
                    mcDefaultQuadParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDefaultQuadParticleSystemTemplate;
                break;

                case EPSEffects.DefaultTexturedQuadParticleSystemTemplate:
                    mcDefaultTexturedQuadParticleSystemTemplate.AutoInitialize(this.GraphicsDevice, this.Content);
                    mcCurrentParticleSystem = mcDefaultTexturedQuadParticleSystemTemplate;
                break;
            }
        }
        ...
        protected override void Update(GameTime cGameTime)
        {
            ...
            {
                // Perform any Particle System specific updates first
                switch (meCurrentPS)
                {
                    default:
                    break;

                    // Update Quad Particle Systems to know where the Camera is
                    case EPSEffects.RotatingQuad:
                        mcRotatingQuadParticleSystem.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.Box:
                        mcBoxParticleSystem.CameraPosition = msCamera.Position;
                    break;
                    
                    case EPSEffects.Image:
                        mcImageParticleSystem.CameraPosition = msCamera.Position;    
                    break;

                    case EPSEffects.GridQuad:
                        mcGridQuadParticleSystem.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.AnimatedTexturedQuad:
                        mcAnimatedQuadParticleSystem.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.QuadParticleSystemTemplate:
                        mcQuadParticleSystemTemplate.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.TexturedQuadParticleSystemTemplate:
                        mcTexturedQuadParticleSystemTemplate.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.DefaultQuadParticleSystemTemplate:
                        mcDefaultQuadParticleSystemTemplate.CameraPosition = msCamera.Position;
                    break;

                    case EPSEffects.DefaultTexturedQuadParticleSystemTemplate:
                        mcDefaultTexturedQuadParticleSystemTemplate.CameraPosition = msCamera.Position;
                    break;
                }
            ...
            if (mcSphere.bVisible && meCurrentPS == EPSEffects.Smoke)
            {
                ...
                if (mcSphere.cTimeAliveInSeconds > TimeSpan.FromSeconds(6.0f))
                {
                    ...
                    mcSmokeParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcSmokeParticleSystem.RepelParticleFromExternalObject);
                    mcSmokeParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcSmokeParticleSystem.AttractParticleToExternalObject);
                }
            }
        ...
        void DrawText()
        {
            ...
            switch (meCurrentPS)
            {
                ...
                case EPSEffects.Random:
                    sEffectName = mcRandomParticleSystem.Name;
                break;
                ...
                case EPSEffects.Smoke:
                    sEffectName = mcSmokeParticleSystem.Name;
                break;

                case EPSEffects.Snow:
                    sEffectName = mcSnowParticleSystem.Name;
                break;

                case EPSEffects.SquarePattern:
                    sEffectName = mcSquarePatternParticleSystem.Name;
                break;

                case EPSEffects.Fountain:
                    sEffectName = mcFountainParticleSystem.Name;
                break;

                case EPSEffects.Random2D:
                    sEffectName = mcRandom2DParticleSystem.Name;
                break;

                case EPSEffects.GasFall:
                    sEffectName = mcGasFallParticleSystem.Name;
                break;

                case EPSEffects.Dot:
                    sEffectName = mcDotParticleSystem.Name;
                break;
                ...
                case EPSEffects.Figure8:
                    sEffectName = mcFigure8ParticleSystem.Name;
                break;

                case EPSEffects.Star:
                    sEffectName = mcStarParticleSystem.Name;
                break;

                case EPSEffects.Ball:
                    sEffectName = mcBallParticleSystem.Name;
                break;

                case EPSEffects.RotatingQuad:
                    sEffectName = mcRotatingQuadParticleSystem.Name;
                break;

                case EPSEffects.Box:
                    sEffectName = mcBoxParticleSystem.Name;
                break;

                case EPSEffects.Image:
                    sEffectName = mcImageParticleSystem.Name;
                break;

                case EPSEffects.AnimatedTexturedQuad:
                    sEffectName = mcAnimatedQuadParticleSystem.Name;
                break;

                case EPSEffects.Sprite:
                    sEffectName = mcSpriteParticleSystem.Name;
                break;

                case EPSEffects.AnimatedSprite:
                    sEffectName = mcAnimatedSpriteParticleSystem.Name;
                break;

                case EPSEffects.Pixel:
                    sEffectName = mcPixelParticleSystem.Name;
                break;

                case EPSEffects.Magnets:
                    sEffectName = mcMagnetParticleSystem.Name;
                break;

                case EPSEffects.Sparkler:
                    sEffectName = mcSparklerParticleSystem.Name;
                break;

                case EPSEffects.Grid:
                    sEffectName = mcGridParticleSystem.Name;
                break;

                case EPSEffects.GridQuad:
                    sEffectName = mcGridQuadParticleSystem.Name;
                break;

                case EPSEffects.Sphere:
                    sEffectName = mcSphereParticleSystem.Name;
                break;

                case EPSEffects.PixelParticleSystemTemplate:
                    sEffectName = "Pixel Particle System Template";
                break;

                case EPSEffects.SpriteParticleSystemTemplate:
                    sEffectName = "Sprite Particle System Template";
                break;

                case EPSEffects.PointSpriteParticleSystemTemplate:
                    sEffectName = "Point Sprite Particle System Template";
                break;

                case EPSEffects.QuadParticleSystemTemplate:
                    sEffectName = "Quad Particle System Template";
                break;

                case EPSEffects.TexturedQuadParticleSystemTemplate:
                    sEffectName = "Textured Quad Particle System Template";
                break;

                case EPSEffects.DefaultPixelParticleSystemTemplate:
                    sEffectName = mcDefaultPixelParticleSystemTemplate.Name;
                break;

                case EPSEffects.DefaultSpriteParticleSystemTemplate:
                    sEffectName = mcDefaultSpriteParticleSystemTemplate.Name;
                break;

                case EPSEffects.DefaultPointSpriteParticleSystemTemplate:
                    sEffectName = mcDefaultPointSpriteParticleSystemTemplate.Name;
                break;

                case EPSEffects.DefaultQuadParticleSystemTemplate:
                    sEffectName = mcDefaultQuadParticleSystemTemplate.Name;
                break;

                case EPSEffects.DefaultTexturedQuadParticleSystemTemplate:
                    sEffectName = mcDefaultTexturedQuadParticleSystemTemplate.Name;
                break;
            }
            ...
            if (mbShowCommonControls)
            {
                ...
                mcSpriteBatch.DrawString(mcFont, "E", new Vector2(220, 50), sControlColor);
                ...
                mcSpriteBatch.DrawString(mcFont, "Manually Add Particle:", new Vector2(5, 100), sPropertyColor);
                mcSpriteBatch.DrawString(mcFont, "Z(one), A(many), Q(max)", new Vector2(210, 100), sControlColor);

                mcSpriteBatch.DrawString(mcFont, "Move Emitter:", new Vector2(5, 125), sPropertyColor);
                mcSpriteBatch.DrawString(mcFont, "Home/End, Delete/PgDn, Insert/PgUp", new Vector2(135, 125), sControlColor);
                ...
                mcSpriteBatch.DrawString(mcFont, "W", new Vector2(375, 200), sControlColor);
                ...
                mcSpriteBatch.DrawString(mcFont, "S", new Vector2(665, 50), sControlColor);      

                mcSpriteBatch.DrawString(mcFont, "Toggle Camera Mode:", new Vector2(485, 75), sPropertyColor);
                mcSpriteBatch.DrawString(mcFont, "D", new Vector2(690, 75), sControlColor);
        ...
        public void ProcessInputForParticleSystem(float fElapsedTimeInSeconds)
        {
            ...
            if (KeyIsDown(Keys.Delete) || ButtonIsDown(Buttons.DPadLeft))
            {
                mcCurrentParticleSystem.Emitter.PositionData.Position += Vector3.Left * fEmitterMoveDelta;
            }

            if (KeyIsDown(Keys.PageDown) || ButtonIsDown(Buttons.DPadRight))
            {
            ...
            if (KeyWasJustPressed(Keys.E) || ButtonWasJustPressed(Buttons.X))
            {
            ...
            switch (meCurrentPS)
            {
                ...
                case EPSEffects.Smoke:
                    ...
                    if (KeyWasJustPressed(Keys.V))
                    {
                        ...
                        // Make sure we only apply the Repel function once
                        mcSmokeParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcSmokeParticleSystem.AttractParticleToExternalObject);
                        mcSmokeParticleSystem.ParticleEvents.AddEveryTimeEvent(mcSmokeParticleSystem.AttractParticleToExternalObject);
                    }
                    ...
                    if (KeyWasJustPressed(Keys.B))
                    {
                        ...
                        // Make sure we only apply the Repel function once
                        mcSmokeParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcSmokeParticleSystem.RepelParticleFromExternalObject);
                        mcSmokeParticleSystem.ParticleEvents.AddEveryTimeEvent(mcSmokeParticleSystem.RepelParticleFromExternalObject);
                    }
                ...
                case EPSEffects.Snow:
                    if (KeyWasJustPressed(Keys.X))
                    {
                        mcSnowParticleSystem.ParticleEvents.AddOneTimeEvent(mcSnowParticleSystem.AddWindForce);
                    }

                    if (KeyWasJustReleased(Keys.C))
                    {
                        mcSnowParticleSystem.ParticleEvents.AddOneTimeEvent(mcSnowParticleSystem.RemoveWindForce);
                    }
                break;
                ...
                case EPSEffects.SquarePattern:
                    ...
                    if (KeyWasJustPressed(Keys.V))
                    {
                        mcSquarePatternParticleSystem.ParticleEvents.AddOneTimeEvent(mcSquarePatternParticleSystem.ChangeParticleColor);
                    }
                break;
                ...
                case EPSEffects.Fountain:
                    if (KeyWasJustPressed(Keys.X))
                    {
                        mcFountainParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcFountainParticleSystem.BounceOffFloor);
                        mcFountainParticleSystem.ParticleEvents.AddEveryTimeEvent(mcFountainParticleSystem.BounceOffFloor);
                    }
                    ...
                    if (KeyWasJustPressed(Keys.N))
                    {
                        mcFountainParticleSystem.ParticleEvents.RemoveEveryTimeEvents(mcFountainParticleSystem.UpdateParticleSizeUsingLerp);
                        mcFountainParticleSystem.ParticleEvents.AddEveryTimeEvent(mcFountainParticleSystem.UpdateParticleSizeUsingLerp);
                    }
                ...
                case EPSEffects.RotatingQuad:
                    if (KeyWasJustPressed(Keys.X))
                    {
                        mcRotatingQuadParticleSystem.ParticleEvents.RemoveEveryTimeEvents(1);
                    }

                    if (KeyWasJustPressed(Keys.C))
                    {
                        mcRotatingQuadParticleSystem.ParticleEvents.RemoveEveryTimeEvents(1);
                        mcRotatingQuadParticleSystem.ParticleEvents.AddEveryTimeEvent(mcRotatingQuadParticleSystem.UpdateParticleToFaceTheCamera, 100, 1);
                    }

                    if (KeyWasJustPressed(Keys.V))
                    {
                        mcRotatingQuadParticleSystem.ParticleEvents.RemoveEveryTimeEvents(1);
                        mcRotatingQuadParticleSystem.ParticleEvents.AddEveryTimeEvent(mcRotatingQuadParticleSystem.UpdateParticleToFaceCenter, 100, 1);
                    }
